...
public final class ActivityOnboardingBinding implements ViewBinding {
  ...
  private ActivityOnboardingBinding(@NonNull ConstraintLayout rootView,
      @NonNull Button buttonGetStarted, @NonNull ImageView imageView4,
  ...
  public static ActivityOnboardingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      Button buttonGetStarted = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityOnboardingBinding((ConstraintLayout) rootView, buttonGetStarted,
          imageView4, main, textView2, textView3);
    }
